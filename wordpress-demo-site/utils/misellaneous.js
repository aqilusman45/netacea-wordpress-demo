...
export function processBulletin(content = '') {
  return sanitizeHtml(content, {
    ...
    allowedAttributes: {
      ...
      a: ['class', 'href', 'name', 'target', 'rel', 'style'],
      span: ['class', 'style'],
    },
  })
}
...
export function mapVariant(variant) {
  const variants = {
    ...
    6: 'primary',
    7: 'primary-border',
    8: 'primary-border-download',
    9: 'primary-border-download-white',
    10: 'primary-border-light',
    11: 'primary-border-with-play-icon',
    12: 'primary-cheveron',
    13: 'primary-orange',
    15: 'text-link-blue',
    18: 'text-link-white-with-double-arrow-icon',
    14: 'secondary',
    46: 'secondary-cheveron',
...
export function mapDepartment(variant) {
  const variants = {
    ...
    47: 'Senior Staff',
    48: 'Board & Government Relations',
    49: 'Community Advisory Panel (CAP)',
    50: 'Officers',
    51: 'Emeritus Board',
  }
